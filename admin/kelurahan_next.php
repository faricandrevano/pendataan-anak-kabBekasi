...
if (isset($_POST["update"]))
{
    ...
    // VALIDASI INPUT FOTO KK
        ...
        mysqli_query($kon, "UPDATE tb_kelurahan SET nama = '$nama', id_kecamatan = '$kecamatan' WHERE id = '" . $id . "'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-user-edit"></i>&nbsp; EDIT KECAMATAN</h1>

                    <hr>

                    <?php
                    $sql = mysqli_query($kon, "SELECT A.id_kecamatan,A.id as id_kelurahan,A.nama,B.id,B.nama as nama_kecamatan FROM tb_kelurahan A INNER JOIN tb_kecamatan B ON A.id_kecamatan = B.id WHERE A.id = '" . $id . "' ");
                    ...
                    <form class="myForm" method="post" enctype="multipart/form-data">
                      <div class="row mb-3">
                          <strong style="margin-left: 13px">KELURAHAN</strong>
                      </div>
