...
if (isset($_POST["update"]))
{
    ...
    // IDENTITAS ANAK
    $nik_anak  = mysqli_real_escape_string($kon, $_POST["nama"]);


    // VALIDASI INPUT FOTO KK

        // UPDATE DATA KE DATABASE
        mysqli_query($kon, "UPDATE tb_kecamatan SET nama = '$nik_anak' WHERE id = '" . $id . "'");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                    $sql = mysqli_query($kon, "SELECT * FROM tb_kecamatan WHERE id = '" . $id . "'");
                    ...
                    <form class="myForm" method="post" enctype="multipart/form-data">
                      <div class="row mb-3">
                          <strong style="margin-left: 13px">KECAMATAN</strong>
                      </div>
