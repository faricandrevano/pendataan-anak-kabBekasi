...
if (isset($_POST["add"])){
    ...
    $kue = mysqli_query($kon, "SELECT * FROM tb_kecamatan WHERE nama = '$nama'");
        ...
        if ($cek > 0){
            ...
            mysqli_query($kon, "INSERT INTO tb_kecamatan (nama) VALUES ('$nama')");
            ...
            $msg = '<div align="center" class="alert alert-success" role="alert">
                      ...
                      <a href="add_kecamatan.php" class="btn btn-info"><i class="fas fa-search"></i>&nbsp; CEK DATA</a>
                    </div>';
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-user-plus"></i>&nbsp; DAFTAR KECAMATAN KABUPATEN BEKASI</h1>
                    ...
                    <form class="myForm" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input name="nama" type="text" class="form-control" placeholder="MASUKAN NAMA KECAMATAN" required>
                        </div>
                      </div>
